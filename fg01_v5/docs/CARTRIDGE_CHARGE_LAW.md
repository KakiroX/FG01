...
band: roughly 320–760 g, i.e. 6–8 cm objects.** That is a narrow niche in its
own right, and it is **not** the ECO-5 intermediate-mass window (100 kg–3.7 t)
— it sits two to three orders of magnitude below it. The two niches do not
overlap: this envelope (sub-kilogram, 6–8 cm) is squarely inside the
small-debris size class the rest of this study addresses, distinct from
ECO-5's much larger tracked-object regime. (An earlier draft of this section
incorrectly described this envelope as sitting "at the small end of" the
ECO-5 window; that cross-reference has been corrected here.)
